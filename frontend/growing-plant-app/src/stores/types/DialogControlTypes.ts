...
export const RESET_PASSWORD_DIALOG_VISIBLE = 'DIALOG_RESET_PASSWORD_DIALOG_VISIBLE';
export const SUCCESS_RESET_PASSWORD_DIALOG_VISIBLE = 'DIALOG_SUCCESS_RESET_PASSWORD_DIALOG_VISIBLE';
...
interface ResetPasswordDialogVisible {
    type: typeof RESET_PASSWORD_DIALOG_VISIBLE;
    payload: boolean;
}

interface SuccessResetPasswordDialogVisible {
    type: typeof SUCCESS_RESET_PASSWORD_DIALOG_VISIBLE;
    payload: boolean;
}
...
export type DialogControlTypes = LoginDialogVisibleAction |
                                ...
                                SuccessResetPasswordDialogVisible;
